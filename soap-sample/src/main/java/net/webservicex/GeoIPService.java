 ...
 * 2016-11-09T14:44:57.520+03:00
 * Generated source version: 3.1.8
 * 
 */
@WebServiceClient(name = "GeoIPService", 
                  wsdlLocation = "file:/Users/olgatarazanova/Documents/ProjTest/JAVA/learning_java/soap-sample/src/test/resources/geoipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/olgatarazanova/Documents/ProjTest/JAVA/learning_java/soap-sample/src/test/resources/geoipservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/olgatarazanova/Documents/ProjTest/JAVA/learning_java/soap-sample/src/test/resources/geoipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
